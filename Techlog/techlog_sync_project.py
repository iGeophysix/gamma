	...
	for dataset in w.datasets:
		...
		for var in ds.log_list:
			...
			if key in t_dataset_list:
				...
				db.datasetCreate(well, t_dataset, 'DEPTH', 'Measured Depth', 'm', list(ref))
			...
			db.variableSave(well, t_dataset, log.name, log.meta.family, log.meta.units, list(g_log_data))
